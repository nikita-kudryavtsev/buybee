...
<!--const model = ref({-->
<!--  priceFrom: null as any,-->
<!--  priceTo: null as any,-->
<!--})-->

<!--const toSnakeCase = (v: string) => v.replace(/(([a-z])(?=[A-Z][a-zA-Z])|([A-Z])(?=[A-Z][a-z]))/g,'$1_').toLowerCase()-->
...
<!--  model.value.priceFrom = currentItem.from-->
<!--  model.value.priceTo = currentItem.to-->
<!--}-->
...
<!--      model.value[toSnakeCase(key)] = value-->
<!--    }-->
<!--  })-->
<!--})-->
<!--const updateQueryParams = () => {-->
<!--  queryParams.value = Object.entries(model.value).reduce((acc: Record<string, string>, [key, value]) => {-->
<!--    if (value) {-->
...
<!--      <Label>Цена</Label>-->
<!--      <div class="flex gap-4">-->
<!--        <Input v-model="model.priceFrom" placeholder="От" type="number" />-->
<!--        <Input v-model="model.priceTo" placeholder="До" type="number" />-->
<!--      </div>-->
...
<!--        </div>-->
<!--      </RadioGroup>-->
<!--      <Button @click="applyFilters">Применить фильтрацию</Button>-->
<!--    </div>-->
<!--  </div>-->
<!--</template>-->